...
//     assert!(!is_double_tile_bigger(1, Some((2, 0)), &tiles));

//     assert!(!is_double_tile_bigger(3, Some((2, 0)), &tiles));

//     assert!(is_double_tile_bigger(1, None, &tiles));
// }
...
//     assert!(tile.can_adjoin(&other_tile));

//     let non_adjoining_tile = Tile::new(Face::Three, Face::Four);
//     assert!(!tile.can_adjoin(&non_adjoining_tile));
// }
...
//     players.insert(actor1);
//     players.insert(actor2);
//     let players = Players {
//         players,
//     };
...
//         assert!(!tiles_indicator[id as usize]);
