// use battleship_io::{BattleshipAction, BattleshipInit, BattleshipState, Entity, Ships};
// use gstd::prelude::*;
// use gtest::{Program, System};

// fn init_battleship(sys: &System) {
//     let battleship = Program::current(sys);
//     let bot = Program::from_file(sys, "target/wasm32-unknown-unknown/debug/bot.opt.wasm");
...
//     for step in steps {
//         let state: BattleshipState = battleship.read_state().expect("Unexpected invalid state.");
