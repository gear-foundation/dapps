...
fn fail_helper_already_added() {
    ...
    student_nft.add_course_helper(user, 1, helper, false);
    student_nft.add_course_helper(user, 1, helper, true);
}

#[test]
fn fail_only_owner_can_add_helper() {
    let system = System::new();
    system.init_logger();
    ...
    student_nft.add_course_helper(fake, 1, helper, true);
}
