...
export async function shuffleDeckWithProofs({ players, numCards, F, a, d, base, aggKey, deck, encryptWasmFile, encryptZkeyFile, encryptVkey, groth16, snarkjs, program, adminKeyring }) {
