...
impl PokerFactoryService {
    ...
    pub async fn create_lobby(
        ...
        let balance: u128 =
            pts_io::GetBalance::decode_reply_with_prefix("Pts", bytes_reply_balance).unwrap();
        ...
        let request = pts_io::AddAdmin::encode_params_with_prefix("Pts", lobby_address);
        ...
        let request = pts_io::Transfer::encode_params_with_prefix(
            "Pts",
            msg_src,
            lobby_address,
