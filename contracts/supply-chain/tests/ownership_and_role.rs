...
fn ownership_and_role() {
    ...
    fail::approve_by_producer(&supply_chain_program, FOREIGN_USER, ITEM_ID[0]);
    fail::approve_by_producer(&supply_chain_program, PRODUCER[1], ITEM_ID[0]);
    ...
    fail::approve_by_distributor(&supply_chain_program, FOREIGN_USER, ITEM_ID[0]);
    fail::approve_by_distributor(&supply_chain_program, DISTRIBUTOR[1], ITEM_ID[0]);
