    ...
    <footer className={styles.footer}>
              ...
              <div className={styles.banner__container}>
                <div className={styles.banner__right}>
                  <h2 className={styles.banner__title}>
                    ...
                    <span>in the Vara Network.</span>
                  </h2>
                  <div className={styles.banner__text}>
                    <p>You've experienced a fully on-chain game.</p>
                    <p>
                      We look forward to having you join the ranks of developers
                      shaping the new generation of decentralized applications.
                    </p>
                  </div>
                </div>
                <ul className={styles.banner__left}>
                  <li className={styles.banner__item}>
                    ...
                    <p className="">
                      Visit the{' '}
                      <a
                        href="https://wiki.gear-tech.io/"
                        target="_blank"
                        rel="noreferrer"
                      >
                        Gear Wiki
                      </a>{' '}
                      to discover how easy it is to create programs using the
                      Gear Protocol.
                    </p>
                  </li>
                  <li className={styles.banner__item}>
                    ...
                    <p className="">
                      ...
                      <a
                        href="https://academy.gear.foundation/"
                        target="_blank"
                        rel="noreferrer"
                      >
                        Gear&nbsp;Academy
      ...
      <Container
        className={clsx(
          ...
          !!gameState?.gameOver && styles.mobile
        )}
      >
        <Sprite
          name="vara-logo"
          className={styles.footer__logo}
          aria-label="Vara Network logotype"
        />
