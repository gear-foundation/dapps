...
export const FindGame = ({ closeFindGame }: { closeFindGame: () => void }) => {
  ...
  return (
    <div className="basis-[540px] grow lg:grow-0">
      ...
      <p className="mt-3 text-[#555756]">To join the game, specify the address received from the game administrator.</p>
      <div className="mt-6">
        <Input type="text" label="Specify the game admin address:" placeholder="kG…" {...getInputProps('creator')} />
      </div>
      ...
      {isOpenModal && (
        <Modal heading="The game has been found" onClose={() => setOpenModal(false)}>
          <p>
            ...
            need to pay the entry fee immediately after clicking the “Join” button.
          </p>
