                    ...
                    <div className="bg-[#F7F9FA] rounded-2xl text-black p-4">
                      <div className="flex flex-col gap-2">
                        ...
                        <div className="flex items-center justify-between pr-[100px]">
                          ...
                          <div className="cursor-pointer text-[#0ED3A3] font-semibold flex items-center" onClick={onCopy}>
                    ...
                    <div className="flex flex-col gap-1 my-5">
                      {reversedArrayPlayers.map((player, i) => {
                        return (
                          <div
                            key={player}
                            className={cn("py-2 px-6 rounded-2xl border-solid border border-[#EDEDED] text-black flex items-center justify-between",
                            ...
                            {i !== 0 &&
                              <button className="p-0 bg-transparent border-none cursor-pointer" onClick={() => onDeletePlayer(player)}>
