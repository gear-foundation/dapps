...
export const ENV = {
  ...
  DNS_CONTRACT_ADDRESS:
    (import.meta.env.VITE_DNS_CONTRACT_ADDRESS as `0x${string}`) ||
    '0xac5cef8afe545a47c414a5e1e4606b6cc81c4b27974f20b36d85ce9459b2d5fa',
  ...
  SIGNLESS_DEFAULT_DURATION_MINUTES: import.meta.env.VITE_SIGNLESS_DEFAULT_DURATION_MINUTES,
  TELEGRAM_BOT_NAME: import.meta.env.VITE_TELEGRAM_BOT_NAME as string,
};
...
export const UI_TIME_COVER_MS = 4000;
