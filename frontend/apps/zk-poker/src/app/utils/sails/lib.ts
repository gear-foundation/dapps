...
export class Program {
  ...
  constructor(public api: GearApi, private _programId?: `0x${string}`) {
    const types: Record<string, any> = {
      Config: {"admin_id":"[u8;32]","admin_name":"String","lobby_name":"String","small_blind":"u128","big_blind":"u128","starting_bank":"u128","time_per_move_ms":"u64"},
      PublicKey: {"x":"[u8; 32]","y":"[u8; 32]","z":"[u8; 32]"},
      VerifyingKeyBytes: {"alpha_g1_beta_g2":"Vec<u8>","gamma_g2_neg_pc":"Vec<u8>","delta_g2_neg_pc":"Vec<u8>","ic":"Vec<Vec<u8>>"},
  ...
  newCtorFromCode(code: Uint8Array | Buffer | HexString, config: Config, pts_actor_id: ActorId, pk: PublicKey, vk_shuffle_bytes: VerifyingKeyBytes, vk_decrypt_bytes: VerifyingKeyBytes): TransactionBuilder<null> {
  ...
  newCtorFromCodeId(codeId: `0x${string}`, config: Config, pts_actor_id: ActorId, pk: PublicKey, vk_shuffle_bytes: VerifyingKeyBytes, vk_decrypt_bytes: VerifyingKeyBytes) {
    const builder = new TransactionBuilder<null>(
      this.api,
      this.registry,
      'create_program',
...
export class Poker {
  ...
  */
  ...
  public async activeParticipants(originAddress?: string, value?: number | string | bigint, atBlock?: `0x${string}`): Promise<TurnManagerForActorId> {
  ...
  public async allInPlayers(originAddress?: string, value?: number | string | bigint, atBlock?: `0x${string}`): Promise<Array<ActorId>> {
  ...
  public async alreadyInvestedInTheCircle(originAddress?: string, value?: number | string | bigint, atBlock?: `0x${string}`): Promise<Array<[ActorId, number | string | bigint]>> {
  ...
  public async betting(originAddress?: string, value?: number | string | bigint, atBlock?: `0x${string}`): Promise<BettingStage | null> {
  ...
  public async bettingBank(originAddress?: string, value?: number | string | bigint, atBlock?: `0x${string}`): Promise<Array<[ActorId, number | string | bigint]>> {
  ...
  public async encryptedTableCards(originAddress?: string, value?: number | string | bigint, atBlock?: `0x${string}`): Promise<Array<EncryptedCard>> {
  ...
  public async factoryActorId(originAddress?: string, value?: number | string | bigint, atBlock?: `0x${string}`): Promise<ActorId> {
  ...
  public async participants(originAddress?: string, value?: number | string | bigint, atBlock?: `0x${string}`): Promise<Array<[ActorId, Participant]>> {
  ...
  public async playerCards(player_id: ActorId, originAddress?: string, value?: number | string | bigint, atBlock?: `0x${string}`): Promise<Array<EncryptedCard> | null> {
  ...
  public async ptsActorId(originAddress?: string, value?: number | string | bigint, atBlock?: `0x${string}`): Promise<ActorId> {
  ...
  public async revealedPlayers(originAddress?: string, value?: number | string | bigint, atBlock?: `0x${string}`): Promise<Array<[ActorId, [Card, Card]]>> {
  ...
  public async revealedTableCards(originAddress?: string, value?: number | string | bigint, atBlock?: `0x${string}`): Promise<Array<Card>> {
  ...
  public async round(originAddress?: string, value?: number | string | bigint, atBlock?: `0x${string}`): Promise<bigint> {
  ...
  public async status(originAddress?: string, value?: number | string | bigint, atBlock?: `0x${string}`): Promise<Status> {
  ...
  public async tableCardsToDecrypt(originAddress?: string, value?: number | string | bigint, atBlock?: `0x${string}`): Promise<Array<EncryptedCard>> {
  ...
  public async waitingParticipants(originAddress?: string, value?: number | string | bigint, atBlock?: `0x${string}`): Promise<Array<[ActorId, Participant]>> {
  ...
  public subscribeToRegisteredEvent(callback: (data: { participant_id: ActorId; pk: PublicKey }) => void | Promise<void>): Promise<() => void> {
    return this._program.api.gearEvents.subscribeToGearEvent('UserMessageSent', ({ data: { message } }) => {;
      ...
      if (getServiceNamePrefix(payload) === 'Poker' && getFnNamePrefix(payload) === 'Registered') {
        callback(this._program.registry.createType('(String, String, {"participant_id":"[u8;32]","pk":"PublicKey"})', message.payload)[2].toJSON() as unknown as { participant_id: ActorId; pk: PublicKey });
      }
    });
  }
  ...
  public subscribeToRegisteredToTheNextRoundEvent(callback: (data: { participant_id: ActorId; pk: PublicKey }) => void | Promise<void>): Promise<() => void> {
    return this._program.api.gearEvents.subscribeToGearEvent('UserMessageSent', ({ data: { message } }) => {;
      if (!message.source.eq(this._program.programId) || !message.destination.eq(ZERO_ADDRESS)) {
        return;
      }
