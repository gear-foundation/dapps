          ...
          <ul>
            ...
            <li>
              <div className="flex items-center py-2.5 pl-12 space-x-7">
                ...
                <div className="grid grid-cols-3 gap-4 text-[#F24A4A]">
                  <div>
                    <Icons.flameActive secondary="#A02D30" className="w-9 h-9" />
                  </div>
                  <div>
                    <Icons.flameActive secondary="#A02D30" className="w-9 h-9" />
                  </div>
            ...
            <li>
              <div className="flex items-center py-2.5 pl-24 space-x-7">
                ...
                <div className="grid grid-cols-3 gap-4 text-[#F24A4A]">{lifeIcons}</div>
              </div>
            </li>
          </ul>
          <LevelsStartAction className="bg-[#F24A4A] hover:bg-[#A02D30]" level="Hard" />
        </div>
      </LevelsModeContent>
    </>
  );
