          ...
          <ul>
            ...
            <li>
              <div className="flex items-center py-2.5 pl-12 space-x-7">
                ...
                <div className="grid grid-cols-3 gap-4 text-[#F46402]">
                  <div>
                    <Icons.flameActive secondary="#933F0D" className="w-9 h-9" />
                  </div>
                  <div>
                    <Icons.flameActive secondary="#933F0D" className="w-9 h-9" />
                  </div>
            ...
            <li>
              <div className="flex items-center py-2.5 pl-24 space-x-7">
                ...
                <div className="grid grid-cols-3 gap-4 text-[#F46402]">{lifeIcons}</div>
              </div>
            </li>
          </ul>
        </div>
        <LevelsStartAction className="bg-[#F46402] hover:bg-[#933F0D]" level="Medium" />
      </LevelsModeContent>
    </>
  );
}
