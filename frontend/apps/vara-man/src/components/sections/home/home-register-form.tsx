...
export function HomeRegisterForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="grid gap-4 w-full max-w-[400px] mx-auto">
      <div className="">
        <Input placeholder="Nickname" direction="y" {...getInputProps('nickname')} />
      </div>
      <div className="flex justify-center">
        <button
          type="submit"
          disabled={Object.keys(errors).length > 0 || isPending}
          className={cn('btn btn--primary w-full max-w-[205px]', isPending && 'btn--loading')}>
