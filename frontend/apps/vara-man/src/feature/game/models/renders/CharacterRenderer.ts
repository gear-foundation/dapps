...
export class CharacterRenderer {
  ...
  static renderCloak(context: CanvasRenderingContext2D, character: Character): void {
    if (this.cloakImage && this.cloakImage.complete) {
      ...
      context.drawImage(this.cloakImage, -this.cloakImage.naturalWidth / 2, -this.cloakImage.naturalHeight / 2);
      context.restore();
    }
  }
}
